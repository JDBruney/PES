...
tempbackflow, tempsidesphere, tempbelowsphere, tempabovesphere,Drho,t !, wu(XN+1), wv(XN+1),
...
drhogover8mu           = Drho*g/(8.0*mu); !coefficient for the perturbation flow
if (RorZ > 0) then

...
real (kind=8), parameter :: rhot                =value1;
!density of top fluid
real (kind=8), parameter :: rhob                =value2;!1.36239!1.37891;
!density of bottom fluid
real (kind=8), parameter :: rhos                =value3;!1.46755;
!diffsuion coefficient
real (kind=8), parameter :: D                  = value4;!17.59;
!density of the sphere
real (kind=8), parameter :: mu                  = 4!17.59;
...
real (kind=8), parameter :: maxTime             = 600000;
!time to run to
...
real (kind=8), parameter :: dt                  = 2;!time step
...
real (kind = 8 ) :: FFR =0! radius of full solution, make FFR = 0 for using far field all the time
...
real (kind=8), parameter :: upperZ = 4000.0;
...
stressbelowsphereE, stresssidesphereE, stressabovesphereE, stressbackflowE,cindex,t
...
call newtonC(t,D, rhot,rhob,Drho)
stresspertcoeff = 0.25*g*Drho*R*2.0*pi;    	!coefficient of the perturbatio stress
